      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="p-6 sm:p-8">
          ...
          <form onSubmit={(e)=> handleLogin(e)} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full mt-1 inline-flex items-center justify-center px-4 py-2 rounded-lg bg-indigo-600 text-white font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-300 transition shadow-sm"
            >
              Log in
            </button>
            ...
            <p className="text-xs text-gray-500 mt-3 text-center">Forgot password? <a href="#" className="text-indigo-600 font-medium">Reset</a></p>
          </form>
        </div>
